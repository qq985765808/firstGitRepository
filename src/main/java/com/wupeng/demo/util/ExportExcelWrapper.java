 ...
 * ExportExcel包装类
 * */
public class ExportExcelWrapper<T> extends ExportExcelUtil<T> implements Serializable {

    private static final long serialVersionUID = 1L;
    private  final  static Log log = LogFactory.getLog(ExportExcelUtil.class);
